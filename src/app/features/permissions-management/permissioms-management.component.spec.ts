...
describe('PermissionsManagementComponent', () => {
  ...
  it('should render page title', () => {
    ...
    expect(title.nativeElement.textContent).toContain('Permissions Management');
  });

  it('should render page subtitle', () => {
    const subtitle = fixture.debugElement.query(By.css('.text-muted-foreground'));
    expect(subtitle.nativeElement.textContent).toContain('Manage permissions and access control');
  });

  it('should render New Permission button', () => {
    const addButton = fixture.debugElement.query(By.css('tolle-button'));
    expect(addButton.nativeElement.textContent).toContain('New Permission');
  });
