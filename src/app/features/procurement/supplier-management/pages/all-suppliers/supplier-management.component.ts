...
export class SupplierManagementComponent implements OnInit {
  ...
  approveSupplier(supplier: Supplier) {
    ...
    ref.afterClosed$.subscribe(confirmed => {
      ...
      this.applyFilter();
      this.toast.show({ title: 'Supplier Approved', description: `${supplier.name} has been approved and is now active.`, variant: 'success' });
    });
  }
  ...
  rejectSupplier(supplier: Supplier) {
    ...
    ref.afterClosed$.subscribe(confirmed => {
      ...
      this.applyFilter();
      this.toast.show({ title: 'Supplier Rejected', description: `${supplier.name} has been rejected and marked inactive.`, variant: 'destructive' });
    });
  }
  ...
  submitSupplier() {
    ...
    setTimeout(() => {
      ...
      this.toast.show({ title: 'Supplier Added', description: 'The new supplier has been submitted and is pending approval.', variant: 'success' });
    }, 600);
  }
