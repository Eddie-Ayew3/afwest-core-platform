...
import { NewClientManagementComponent } from './new-client-management.component';



describe('NewClientManagementComponent', () => {
  let component: NewClientManagementComponent;
  let fixture: ComponentFixture<NewClientManagementComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [NewClientManagementComponent]
    })
    .compileComponents();

    fixture = TestBed.createComponent(NewClientManagementComponent);
