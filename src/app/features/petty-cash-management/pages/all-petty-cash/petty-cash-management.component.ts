...
import {
  ...
  DataTableComponent, TolleCellDirective, TableColumn, CardComponent, CardContentComponent,
...
@Component({
  ...
  imports: [
    ...
    DataTableComponent, TolleCellDirective, CardComponent, CardContentComponent,
    EmptyStateComponent,
  ],
...
export class PettyCashManagementComponent implements OnInit {
  ...
  approveTransaction(t: Transaction) {
    ...
    ref.afterClosed$.subscribe(confirmed => {
      ...
      this.applyFilter();
      this.showAlert('success', 'Expense Approved', `${t.reference} has been approved.`);
    });
  }
  ...
  rejectTransaction(t: Transaction) {
    ...
    ref.afterClosed$.subscribe(confirmed => {
      ...
      t.status = 'Rejected';
      this.applyFilter();
      this.showAlert('destructive', 'Expense Rejected', `${t.reference} has been rejected.`);
    });
  }
  ...
  submitExpense() {
    ...
    setTimeout(() => {
      ...
      this.showAlert('success', 'Expense Submitted', 'Your expense claim has been submitted and is pending approval.');
    }, 600);
  }
