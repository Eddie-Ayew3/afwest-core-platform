...
describe('DashboardLayoutComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ClientDashboardLayoutComponent, RouterTestingModule]
    })
    .compileComponents();
  ...
  it('should have sidebar items defined', () => {
    expect(component.clientSidebarItems).toBeDefined();
    expect(component.clientSidebarItems.length).toBeGreaterThan(0);
  });
