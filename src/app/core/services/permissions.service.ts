...
export class PermissionsService {
  ...
  buildSidebarItems(): SidebarGroup[] {
    ...
    if (this.canSee('finance_invoice')) financeItems.push({ title: 'Client Invoices',    url: '/finance/invoice-management', icon: 'ri-file-list-3-line' });
    if (this.canSee('finance_sla'))     financeItems.push({ title: 'SLA Compliance',     url: '/finance/sla-report' });
